...
export default function Home() {
  ...
  const Backgrounds = [
    {
      title: 'Background 1',
      src: 'src/assets/backgrounds/wallpaper1.gif',
    },
    {
      title: 'Background 2',
      src: 'src/assets/backgrounds/wallpaper2.jpg',
    },
    {
      title: 'Background 3',
      src: 'src/assets/backgrounds/wallpaper3.gif',
    },
    {
      title: 'Background 4',
      src: 'src/assets/backgrounds/wallpaper4.gif',
    },
    {
      title: 'Background 5',
      src: 'src/assets/backgrounds/wallpaper5.gif',
    },
    {
      title: 'Background 6',
      src: 'src/assets/backgrounds/wallpaper6.gif',
    },
    {
      title: 'Background 7',
      src: 'src/assets/backgrounds/wallpaper7.gif',
    },
  ];
